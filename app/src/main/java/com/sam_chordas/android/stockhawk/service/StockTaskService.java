      ...
      try{
        ...
        try {
          ...
          else
          {
            ...
            intent.setAction("com.sam_chordas.android.stockhawk.service.StockInvalidReciever");
            mContext.sendBroadcast(intent);
          }
        }catch (RemoteException | NumberFormatException | OperationApplicationException e){
